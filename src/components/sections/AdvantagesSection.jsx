      ...
      <div className="flex justify-between items-center max-section-screen mx-auto max-sm:flex-col">
          ...
          <ul>
            <li className="flex items-center mb-16 gap-7">
              <img
                ...
                src="./src/assets/sections/AdvantSectionImg.png"
                alt=""
              />
              <p className="text-4xl max-sm:mx-auto max-sm:bg-[#1AB1F6] max-sm:p-2 max-sm:rounded-3xl max-sm:text-white max-sm:font-thin">
                Easy to use
              </p>
            </li>
            <li className="flex items-center mb-16 gap-7">
        ...
        <div className="mx-auto flex flex-col items-center">
          <img
            ...
            src="./src/assets/sections/AdvantSectionWorksImg.png"
            alt=""
          />
